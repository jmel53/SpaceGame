...
onEvent("screen1", "keydown", function(event) {
    ...
    var xOverlap=Math.max(0, Math.min(rx+30, ax+50)-Math.max(rx,ax)+1)>0 ;
    var yOverlap= Math.max(0, Math.min(ry+100, ay+50)-Math.max(ry,ay)+1)>0;
    
    var xOverlap2=Math.max(0, Math.min(rx+30, ax2+50)-Math.max(rx,ax2)+1)>0 ;
    var yOverlap2= Math.max(0, Math.min(ry+100, ay2+50)-Math.max(ry,ay2)+1)>0;
    
    var xOverlap3=Math.max(0, Math.min(rx+30, ax3+50)-Math.max(rx,ax3)+1)>0 ;
